...
.quiz-card:active { transform: scale(.998); box-shadow: 0 6px 18px rgba(0,0,0,.35); }
 ...
 .a { position: absolute; bottom: 0; left: 0; right: 0; margin-top: 14px; font-size: clamp(18px, 2.3vw, 22px); color: #d6f2ff; opacity: 0; visibility: hidden; max-height: 0; overflow: hidden; transition: opacity 0.3s ease, visibility 0.3s ease, max-height 0.3s ease; padding: 0 clamp(18px, 3.5vw, 28px) clamp(18px, 3.5vw, 28px) clamp(18px, 3.5vw, 28px); }
